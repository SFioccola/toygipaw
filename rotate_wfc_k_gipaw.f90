...
!
!----------------------------------------------------------------------------
SUBROUTINE rotate_wfc_k_gipaw ( h_psi_gipaw, s_psi, overlap, &
  ...
  CALL h_psi_gipaw ( npwx, npw, nstart, psi, aux )
  ...
  RETURN
  !
END SUBROUTINE rotate_wfc_k_gipaw
!
!
!----------------------------------------------------------------------------
SUBROUTINE protate_wfc_k_gipaw( h_psi_gipaw, s_psi, overlap, &
                          npwx, npw, nstart, nbnd, npol, psi, evc, e )
  !----------------------------------------------------------------------------
  !
  ...
  CALL compute_distmat_gipaw( hc, psi, aux ) 
  !            
  IF ( overlap ) THEN
     !
     CALL s_psi( npwx, npw, nstart, psi, aux )
     CALL compute_distmat_gipaw( sc, psi, aux )
     !
  ELSE
     !
     CALL compute_distmat_gipaw( sc, psi, psi )
     !  
  END IF
...
CONTAINS
  !
  SUBROUTINE compute_distmat_gipaw( dm, v, w )
     !
     ...
     !
     RETURN
  END SUBROUTINE compute_distmat_gipaw


  SUBROUTINE refresh_evc_gipaw( )
     !
     INTEGER :: ipc, ipr
     INTEGER :: nr, nc, ir, ic, root
     ...
     RETURN
  END SUBROUTINE refresh_evc_gipaw

END SUBROUTINE protate_wfc_k_gipaw
