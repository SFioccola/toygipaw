...
10      IF ( ierr /= 0 ) THEN
  ...
  RETURN
  !
END SUBROUTINE wfcinit_gipaw
!
!----------------------------------------------------------------------------
SUBROUTINE init_wfc_gipaw ( ik )
  !----------------------------------------------------------------------------
  !
...
!civn: becp_d to be removed as soon as calbec is fixed
  ...
  RETURN
  !
END SUBROUTINE init_wfc_gipaw
!
!----------------------------------------------------------------------------
SUBROUTINE aceinit0_gipaw ()
  !----------------------------------------------------------------------------
  !
